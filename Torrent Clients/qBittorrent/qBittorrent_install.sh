function qBittorrent_download {
    ...
    do
        case $opt in
            "qBittorrent 4.4.5 - libtorrent-2.0.8")
                version=4.1.9; wget https://github.com/userdocs/qbittorrent-nox-static/releases/download/release-4.4.5_v2.0.8/x86_64-qbittorrent-nox; break
                ;;
